...
import adminServices from "../../services/adminOrder/adminServices"; // Import the admin services
...
const OrderForm = () => {
  ...
  const handleSubmit = async (evt) => {
    ...
    // Call the service to create a new admin order
    try {
      ...
      // You can add success handling here (e.g., clear the form, show success message, etc.)
    } catch (error) {
